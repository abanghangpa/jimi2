...
print('DEBUG: Finished def fetch_all_tradfi_data(config at', time.time(), flush=True)
...
print('DEBUG: Finished tradfi_data at', time.time(), flush=True)
...
print('DEBUG: Finished df_15m at', time.time(), flush=True)
...
print('DEBUG: Finished m13_status, m13_score_raw, m13_details at', time.time(), flush=True)
...
print('DEBUG: Finished m7_status, m7_score, m7_details at', time.time(), flush=True)
...
print('DEBUG: Finished _m20_pre_status, _m20_pre_score, _m20_pre_result at', time.time(), flush=True)
                df_15m, idx, 'NEUTRAL',
...
print('DEBUG: Finished _m13_status2, _m13_score2, m13_details at', time.time(), flush=True)
        if not _in_chop:
...
print('DEBUG: Finished m21_status, m21_score, m21_details at', time.time(), flush=True)
...
print('DEBUG: Finished m21_flip_status, m21_flip_score, m21_flip_details at', time.time(), flush=True)
...
print('DEBUG: Finished m23_status, m23_score, m23_details, m23_decay_mult at', time.time(), flush=True)
...
print('DEBUG: Finished m24_status, m24_score_adj, m24_size_mult, m24_details at', time.time(), flush=True)
...
print('DEBUG: Finished m25_status, m25_score_adj, m25_size_mult, m25_details at', time.time(), flush=True)
...
print('DEBUG: Finished m26_status, m26_score_adj, m26_size_mult, m26_details at', time.time(), flush=True)
...
print('DEBUG: Finished m33_status, m33_score_adj, m33_size_mult, m33_details at', time.time(), flush=True)
...
print('DEBUG: Finished m34_status, m34_score_adj, m34_size_mult, m34_details at', time.time(), flush=True)
...
print('DEBUG: Finished m35_status, m35_score_adj, m35_size_mult, m35_details at', time.time(), flush=True)
...
print('DEBUG: Finished m36_status, m36_score_adj, m36_size_mult, m36_details at', time.time(), flush=True)
...
print('DEBUG: Finished m37_status, m37_score_adj, m37_size_mult, m37_details at', time.time(), flush=True)
...
print('DEBUG: Finished m38_status, m38_score_adj, m38_size_mult, m38_details at', time.time(), flush=True)
...
print('DEBUG: Finished m39_status, m39_score_adj, m39_size_mult, m39_details at', time.time(), flush=True)
...
print('DEBUG: Finished m40_status, m40_score_adj, m40_size_mult, m40_details at', time.time(), flush=True)
...
print('DEBUG: Finished m41_status, m41_score_adj, m41_size_mult, m41_details at', time.time(), flush=True)
...
print('DEBUG: Finished m42_status, m42_score_adj, m42_size_mult, m42_details at', time.time(), flush=True)
...
print('DEBUG: Finished m43_status, m43_score_adj, m43_size_mult, m43_details at', time.time(), flush=True)
...
print('DEBUG: Finished m44_status, m44_score_adj, m44_size_mult, m44_details at', time.time(), flush=True)
...
print('DEBUG: Finished m45_status, m45_score_adj, m45_size_mult, m45_details at', time.time(), flush=True)
...
print('DEBUG: Finished m46_status, m46_score_adj, m46_size_mult, m46_details at', time.time(), flush=True)
...
print('DEBUG: Finished m47_status, m47_score_adj, m47_size_mult, m47_details at', time.time(), flush=True)
...
print('DEBUG: Finished m48_status, m48_score_adj, m48_size_mult, m48_details at', time.time(), flush=True)
...
print('DEBUG: Finished m49_status, m49_score_adj, m49_size_mult, m49_details at', time.time(), flush=True)
...
print('DEBUG: Finished m50_status, m50_score_adj, m50_size_mult, m50_details at', time.time(), flush=True)
...
print('DEBUG: Finished m51_status, m51_score_adj, m51_size_mult, m51_details at', time.time(), flush=True)
...
print('DEBUG: Finished m52_status, m52_score_adj, m52_size_mult, m52_details at', time.time(), flush=True)
...
print('DEBUG: Finished m53_status, m53_score_adj, m53_size_mult, m53_details at', time.time(), flush=True)
...
print('DEBUG: Finished m54_status, m54_score_adj, m54_size_mult, m54_details at', time.time(), flush=True)
...
print('DEBUG: Finished m55_status, m55_score_adj, m55_size_mult, m55_details at', time.time(), flush=True)
...
print('DEBUG: Finished m56_status, m56_score_adj, m56_size_mult, m56_details at', time.time(), flush=True)
...
print('DEBUG: Finished m57_status, m57_score_adj, m57_size_mult, m57_details at', time.time(), flush=True)
...
print('DEBUG: Finished m58_status, m58_score_adj, m58_size_mult, m58_details at', time.time(), flush=True)
...
print('DEBUG: Finished m59_status, m59_score_adj, m59_size_mult, m59_details at', time.time(), flush=True)
...
print('DEBUG: Finished m65_status, m65_score_adj, m65_size_mult, m65_details at', time.time(), flush=True)
            today_str=today_str,
...
print('DEBUG: Finished m60_status, m60_score_adj, m60_size_mult, m60_details at', time.time(), flush=True)
...
print('DEBUG: Finished m61_status, m61_score_adj, m61_size_mult, m61_details at', time.time(), flush=True)
...
print('DEBUG: Finished m62_status, m62_score_adj, m62_size_mult, m62_details at', time.time(), flush=True)
...
print('DEBUG: Finished _tradfi_data at', time.time(), flush=True)
...
print('DEBUG: Finished m66_status, m66_score, m66_details at', time.time(), flush=True)
...
print('DEBUG: Finished m67_status, m67_score, m67_details at', time.time(), flush=True)
...
print('DEBUG: Finished _tips_df at', time.time(), flush=True)
            except Exception:
                pass
            m68_status, m68_score, m68_details = score_m68_yield(
print('DEBUG: Finished m68_status, m68_score, m68_details at', time.time(), flush=True)
...
print('DEBUG: Finished m69_status, m69_score, m69_details at', time.time(), flush=True)
...
print('DEBUG: Finished m70_status, m70_score, m70_details at', time.time(), flush=True)
...
print('DEBUG: Finished m71_status, m71_score, m71_details at', time.time(), flush=True)
...
print('DEBUG: Finished _btcdom at', time.time(), flush=True)
            m72_status, m72_score, m72_details = score_m72_btcdom(
print('DEBUG: Finished m72_status, m72_score, m72_details at', time.time(), flush=True)
...
print('DEBUG: Finished _mint_data at', time.time(), flush=True)
            m73_status, m73_score, m73_details = score_m73_stablecoin(
print('DEBUG: Finished m73_status, m73_score, m73_details at', time.time(), flush=True)
...
print('DEBUG: Finished m1_dir, m1_score, _m1_details at', time.time(), flush=True)
...
print('DEBUG: Finished m2_status, m2_score at', time.time(), flush=True)
...
print('DEBUG: Finished m3_status, m3_score, _ at', time.time(), flush=True)
...
print('DEBUG: Finished m4_status, m4_score, m4_div at', time.time(), flush=True)
...
print('DEBUG: Finished m5_status, m5_score, m5_details at', time.time(), flush=True)
        n_bins=cfg['M5_VP_BINS'], lookback=cfg['M5_VP_LOOKBACK'])
...
print('DEBUG: Finished fr_df at', time.time(), flush=True)
...
print('DEBUG: Finished m8_status, m8_score, _ at', time.time(), flush=True)
...
print('DEBUG: Finished m10_status, m10_score, m10_details at', time.time(), flush=True)
...
print('DEBUG: Finished m11_status, m11_score, _ at', time.time(), flush=True)
...
print('DEBUG: Finished m12_status, m12_score, m12_details at', time.time(), flush=True)
...
print('DEBUG: Finished m14_status, m14_score, _ at', time.time(), flush=True)
...
print('DEBUG: Finished m20_status, m20_score, m20_result at', time.time(), flush=True)
...
print('DEBUG: Finished _fred_script at', time.time(), flush=True)
...
print('DEBUG: Finished df_base at', time.time(), flush=True)
...
print('DEBUG: Finished btc_15m_df at', time.time(), flush=True)
