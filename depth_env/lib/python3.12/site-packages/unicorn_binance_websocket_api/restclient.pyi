...
class BinanceWebSocketApiRestclient:
    ...
    def delete_listen_key(self, stream_id=None) -> tuple[str | None, dict | None]: ...
    def get_binance_api_status(self) -> dict: ...
    def get_listen_key(self, stream_id=None) -> tuple[dict | None, dict | None]: ...
    def keepalive_listen_key(self, stream_id=None) -> tuple[str | None, dict | None]: ...
    def stop(self) -> bool: ...
