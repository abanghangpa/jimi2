...
{
    "distutils": {
        "name": "unicorn_binance_websocket_api.api.__init__",
        "sources": [
            "unicorn_binance_websocket_api/api/__init__.py"
        ]
    },
    "module_name": "unicorn_binance_websocket_api.api.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__unicorn_binance_websocket_api__api
#define __PYX_HAVE_API__unicorn_binance_websocket_api__api
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "unicorn_binance_websocket_api.api" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "unicorn_binance_websocket_api.api.__init__"
extern int __pyx_module_is_main_unicorn_binance_websocket_api__api____init__;
int __pyx_module_is_main_unicorn_binance_websocket_api__api____init__ = 0;

/* Implementation of "unicorn_binance_websocket_api.api" */
...
#define __pyx_kp_u_unicorn_binance_websocket_api_ap __pyx_string_tab[1]
...
static CYTHON_SMALL_CODE int __pyx_m_clear(PyObject *m) {
  ...
  #endif
  for (int i=0; i<9; ++i) { Py_CLEAR(clear_module_state->__pyx_string_tab[i]); }
...
static CYTHON_SMALL_CODE int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  for (int i=0; i<9; ++i) { __Pyx_VISIT_CONST(traverse_module_state->__pyx_string_tab[i]); }
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_api(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_api", 0);
  ...
  if (__pyx_module_is_main_unicorn_binance_websocket_api__api____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_unicorn_binance_websocket_api_ap) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "unicorn_binance_websocket_api.api")) {
      if (unlikely((PyDict_SetItemString(modules, "unicorn_binance_websocket_api.api", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "unicorn_binance_websocket_api/api/__init__.py":1
 * #!/usr/bin/env python3             # <<<<<<<<<<<<<<
 * # -*- coding: utf-8 -*-
 * # \_()_/
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init unicorn_binance_websocket_api.api", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init unicorn_binance_websocket_api.api");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{42},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (91 bytes) */
const char* const cstring = "x\332%\214\321\r\2040\014C7\272\025\030\305J\203\221\"\332\024h*\326'p\226l?\377x\231n\332/G1\027W\342f\031]w\006\344\260\337k\300\334\002\320j\316d\304%\312\"\272\003Mr\247Z_g\345K.\355\353sJ\375\363`\254\334d\326\374\010\216\314\007\266D.\257";
    PyObject *data = __Pyx_DecompressString(cstring, 91, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (117 bytes) */
const char* const bytes = "?unicorn_binance_websocket_api.api.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
