...
from .connection_settings import BINANCE_FUTURES_EXCHANGES as BINANCE_FUTURES_EXCHANGES, BINANCE_FUTURES_USERDATA_EVENTS as BINANCE_FUTURES_USERDATA_EVENTS, CEX_EXCHANGES as CEX_EXCHANGES, CONNECTION_SETTINGS as CONNECTION_SETTINGS, FUTURES_SUFFIX_MARKERS as FUTURES_SUFFIX_MARKERS, USERDATA_WS_API_EXCHANGES as USERDATA_WS_API_EXCHANGES
...
class BinanceWebSocketApiManager(threading.Thread):
    ...
    process_asyncio_queue: Callable | None
    process_stream_data: Callable | None
    process_stream_data_async: Callable | None
    ...
    exchange_type: Literal['cex', None]
    ...
    output_default: Literal['dict', 'raw_data', 'UnicornFy'] | None
    ...
    def get_monitoring_status_plain(self, warn_on_update: bool = True): ...
    @staticmethod
    ...
    def get_result_by_request_id(self, request_id=None, timeout: int = 10): ...
    ...
    def increase_reconnect_counter(self, stream_id=None) -> None: ...
    ...
    def replace_stream(self, stream_id, new_channels, new_markets, new_stream_label=None, new_stream_buffer_name: Literal[False] | str = False, new_api_key=None, new_api_secret=None, new_symbols=None, new_output: Literal['dict', 'raw_data', 'UnicornFy'] | None = None, new_ping_interval: int = 20, new_ping_timeout: int = 20, new_close_timeout: int = 10, new_stream_buffer_maxlen=None, new_events: str | Iterable[str] | None = None): ...
    def run(self) -> None: ...
