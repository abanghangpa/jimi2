...
{
    "distutils": {
        "name": "unicorn_fy.__init__",
        "sources": [
            "unicorn_fy/__init__.py"
        ]
    },
    "module_name": "unicorn_fy.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__unicorn_fy
#define __PYX_HAVE_API__unicorn_fy
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "unicorn_fy" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "unicorn_fy.__init__"
extern int __pyx_module_is_main_unicorn_fy____init__;
int __pyx_module_is_main_unicorn_fy____init__ = 0;

/* Implementation of "unicorn_fy" */
...
#define __pyx_kp_u_unicorn_fy_2 __pyx_string_tab[2]
#define __pyx_kp_u_unicorn_fy___init __pyx_string_tab[3]
#define __pyx_n_u_UnicornFy __pyx_string_tab[4]
...
#define __pyx_n_u_unicorn_fy __pyx_string_tab[12]
...
static int __pyx_pymod_exec_unicorn_fy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_unicorn_fy},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_unicorn_fy(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_unicorn_fy(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_unicorn_fy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_unicorn_fy(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'unicorn_fy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "unicorn_fy" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_unicorn_fy", 0);
  ...
  if (__pyx_module_is_main_unicorn_fy____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_unicorn_fy___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "unicorn_fy")) {
      if (unlikely((PyDict_SetItemString(modules, "unicorn_fy", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "unicorn_fy/__init__.py":1
 * from .unicorn_fy import UnicornFy             # <<<<<<<<<<<<<<
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_UnicornFy};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_unicorn_fy, __pyx_imported_names, 1, __pyx_mstate_global->__pyx_kp_u_unicorn_fy_2, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init unicorn_fy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init unicorn_fy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{11},{19},{9},{18},{8},{10},{8},{12},{10},{8},{10}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (92 bytes) */
const char* const cstring = "x\332E\2151\016\300 \010Eo\344\025\272\365\006\235\tELL\025S\205\301\333\227\326\241\014\360\376\033\370a\013&\231Z\027H\363\247\000\220%+\300\261\324>\251da\227\240\035\211O\244\013\240\242g\237\332\242\025~I\260~\3676,\213\007k\344\204V\374\231\362\360\375\267<&\3312\010";
    PyObject *data = __Pyx_DecompressString(cstring, 92, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (125 bytes) */
const char* const bytes = ".?.unicorn_fyunicorn_fy.__init__UnicornFycline_in_traceback__main____module____name____qualname__setdefault__test__unicorn_fy";
    PyObject *data = NULL;
