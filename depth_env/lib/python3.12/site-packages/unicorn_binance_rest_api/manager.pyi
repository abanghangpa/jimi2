...
class BinanceRestApiManager:
    ...
    def aggregate_trade_iter(self, symbol, start_str=None, last_id=None) -> Generator[Incomplete]: ...
    def get_klines(self, **params): ...
    def get_historical_klines(self, symbol, interval, start_str, end_str=None, limit: int = 500): ...
    def get_historical_klines_generator(self, symbol, interval, start_str, end_str=None) -> Generator[Incomplete]: ...
