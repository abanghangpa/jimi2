...
class Cluster:
    ...
    def add_credentials(self, account_group: str = None, api_key: str = None, api_secret: str = None, debug: bool = False) -> dict: ...
    async def add_credentials_async(self, account_group: str = None, api_key: str = None, api_secret: str = None, debug: bool = False) -> dict: ...
